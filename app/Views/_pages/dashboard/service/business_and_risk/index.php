...
<div class="modal fade" id="keypoints_create_modal" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="<?= route_to("object.keypoints.create", "BUSINESS_AND_RISK") ?>" method="post"
              class="modal-content">
...
<div class="modal fade" id="service_line_create_modal" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="<?= route_to("object.service_lines.create", "BUSINESS_AND_RISK") ?>" method="post"
              class="modal-content">
            <div class="modal-header">
...
<script>
    initCkeditor("SERVICE_1_PARAGRAPH_1")
    initCkeditor("SERVICE_1_PARAGRAPH_2")
    initCkeditor("SERVICE_1_PARAGRAPH_3")

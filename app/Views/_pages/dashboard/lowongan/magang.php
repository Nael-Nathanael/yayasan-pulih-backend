    ...
    <div class="container-fluid h-100">
        <section class="h-100">
            <div class="container h-100">
                <input type="hidden" name="LOWONGAN_MAGANG_CONTENT" id="content">
                ...
                <div class="editor border shadow-none bg-white mb-3">
                    <?= $lines->findOrEmptyString("LOWONGAN_MAGANG_CONTENT") ?>
                </div>
                    ...
                    [
                        "fields" => [
                            [
                                ...
                                "id" => "LOWONGAN_MAGANG_BUTTON_TEXT",
                            ],
                            [
                                "type" => "LinesField",
                                "label" => "Link tombol",
                                "id" => "LOWONGAN_MAGANG_BUTTON_HREF",
                            ],
                        ]
                    ]
                ) ?>
